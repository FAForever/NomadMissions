M2_Intro_CDR_Dropped_Dialogue = {
    ...
    {text = "[Nichols]: Hold on...Scans are detecting a heavy presence of enemy units to the east sir.", vid = '', bank = '', cue = '', faction = 'UEF'},
}
...
M2_Secure_River_Dialogue = {
    {text = "[Nichols]: Captain, the UEF have the river to your north locked down. We've uploaded a schematic for a new Naval Factory. Use it to destroy the UEF patrols.", vid = '', bank = '', cue = '', faction = 'UEF'},
}
