...
function P1CybranBase2AI()
    ...
    P1Cbase2:StartNonZeroBase({{4, 5, 6}, {3, 4, 5}})
...
function P1CB1AirAttacks1()
	...
	local Temp = {
       'P1CB1AirAttackTemp0',
       'NoPlan',
       { 'ura0102', 1, 4, 'Attack', 'GrowthFormation' }, --Fighters  
    }
    local Builder = {
...
function P1CB1LandAttacks1()
	...
	Temp = {
       ...
       'NoPlan',
       { 'url0104', 1, quantity[Difficulty], 'Attack', 'GrowthFormation' }, --Fighters
	...
	Temp = {
       ...
       'NoPlan',
       { 'url0202', 1, quantity[Difficulty], 'Attack', 'GrowthFormation' }, --Fighters
	   { 'url0103', 1, 4, 'Attack', 'GrowthFormation' }, --Fighters
    }
    Builder = {
