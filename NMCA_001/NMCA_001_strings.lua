IntroNIS_Dialogue = {
	{text = "[Nichols]: Greetings Captain, this is Nichols speaking; I’ve been assigned as your global reconnaissance agent while you’re deployed on the ground. You will be receiving orders and operational objectives from me unless otherwise contacted directly from command, so buckle up traveller. We’re going to get well acquainted from here on.", vid = 'nomads_m1_intro_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-1', faction = 'Nomad'},
	{text = "[Nichols]: Alright, planetary scans reveal unidentified signatures of human origin located Northwest of your LZ. You’re to set up shop and establish a forward base before opening diplomatic communications.", vid = 'nomads_m1_intro_2.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-2', faction = 'Nomad'},
	{text = "[Nichols]: We suspect this group to be little more than estranged Nomad colonies, so lay off the trigger.", vid = 'nomads_m1_intro_3.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-3', faction = 'Nomad'},
	{text = "[Nichols]: Don’t forget, we're limited on available resources and weaponry, so choose your approach carefully.", vid = 'nomads_m1_intro_4.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-4', faction = 'Nomad'},
}
...
UEF_Notice = {
	...
	{text = "[Nichols]: Captain we’re picking up a transmission from the local inhabitants within your operational area. We’re narrowing down on the signal.", vid = 'nomads_m1_uef_notice_nichols_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-5', faction = 'Nomad'},
	...
	{text = "[Nichols]: Captain he’s not responding to our calls, command has issued that you get off planet now before they retaliate!", vid = 'nomads_m1_uef_notice_nichols_3.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-7', faction = 'Nomad'},
	{text = "[Parker]: [Heavy Static] You're not getting away from me!", vid = '', bank = 'NMCA_001', cue = 'NMCA_P_02', faction = 'UEF'},
}

M1_Scream_Incoming = {
	{text = "[Nichols]: Picking up a missile launch, bearing on your ship! Brace for impact!", vid = 'nomads_m1_scream_incoming_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-8', faction = 'Nomad'},
}

M1_Update_Commander = {
	{text = "[Nichols]: What’s the situation on the ship?", vid = 'nomads_m1_update_commander_nichols_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-9', faction = 'Nomad'},
	{text = "[Benson]: Captain, that missile nearly blew the core out, and our engines are offline. The ship’s being repaired, but we can’t take another hit like that!", vid = 'nomads_m1_update_commander_part1_benson.sfd', bank = 'NMCA_001', cue = 'Benson_Audio_M1_01', faction = 'Nomad'},
	{text = "[Nichols]: Get on it Benson. Captain, command is clearing you to defend yourself by whatever means. I recommend taking out that missile launcher before it fires again.", vid = 'nomads_m1_update_commander_nichols_2.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-10', faction = 'Nomad'},
}

M1_Tac_Dead = {
	{text = "[Nichols]: The Missile Launcher is down!", vid = 'nomads_m1_tac_dead.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-11', faction = 'Nomad'},
}

M1UnlockAirTech = {
	{text = "[Benson]: Captain, we've received clearance for the Light Air Transport and Attack Bomber. The blueprints will be coming online shortly.", vid = 'nomads_m1_unlock_air_tech.sfd', bank = 'NMCA_001', cue = 'Benson_Audio_M1_02', faction = 'Nomad'},
}

UEFOutpost_Dead = {
	{text = "[Parker]: You think I'm done with you Cybran bugs? The UEF prevails against all odds!", vid = '', bank = 'NMCA_001', cue = '', faction = 'UEF'},
	{text = "[Nichols]: You have no idea who you’re dealing with!", vid = 'nomads_m1_uef_outpost_dead_nichols_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-12', faction = 'Nomad'},
}

M2_Update_Commander = {
	{text = "[Nichols]: The fight’s not over, scans indicate that the heart of their production is located further north toward the mountainside. We’ve identified what looks to be a research plant deep within hostile territory. Your objective now is to capture this facility and collect as much as data as you can.", vid = 'nomads_m1_update_commander_part2_nichols_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-13', faction = 'Nomad'},
	{text = "[Nichols]: Scans indicate two point defense structures screening the forward entrance to the base, but the rear toward the canyon might be vulnerable. You can use some transports to flank their defensive perimeter.", vid = 'nomads_m1_update_commander_part2_nichols_2.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-14', faction = 'Nomad'},
	{text = "[Nichols]: Word of warning Captain, this doesn’t look to be anything we’ve seen before of Nomad technology, we might be up against something completely foreign to us. Stay vigilant.", vid = 'nomads_m1_update_commander_part2_nichols_3.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-15', faction = 'Nomad'},
}

M2TechCaptured = {
	{text = "[Nichols]: Good work Captain, were feeding the data you’ve extracted to headquarters for further processing, it’s about time we get the hell off of this planet.", vid = 'nomads_m1_tech_captured_nichols_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-16', faction = 'Nomad'},
	{text = "[Nichols]: Hold on, our satellites have pinpointed the exact location of the enemy base to the Northwest. The base is heavily shielded, and it looks to be the primary production facility within the operational area; if you take this out, you can eliminate the problem head on.", vid = 'nomads_m1_tech_captured_nichols_2.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-17', faction = 'Nomad'},
}

M3_Update_Commander = {
	{text = "[Nichols]: Wait, Captain!... I’m not sure what it is we’re seeing but there looks to be some kind of massive walker stationed at the base. The signature matches with the officer that hailed us earlier; he must be using this as some kind of weaponized command vehicle.", vid = 'nomads_m1_update_commander_part3_nichols_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-18', faction = 'Nomad'},
	{text = "[Nichols]: Command has issued you a direct order: kill whoever is leading the local forces, and get off planet as soon as possible. If he is using that command unit you better use everything you’ve got to take it down.", vid = 'nomads_m1_update_commander_part3_nichols_2.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-19', faction = 'Nomad'},
}

M3_Update_Commander_Power = {
	{text = "[Nichols]: We've also discovered a small Power station to the North, we believe that's keeping the shields active in the base. Destroying that power station will make your assault on the base easier.", vid = 'nomads_m1_update_commander_part3_nichols_3.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-20', faction = 'Nomad'},
}

M3_Update_Commander_Enemy = {
	{text = "[Nichols]: The Enemy Commander is increasing his efforts Captain, stay alert.", vid = 'nomads_m1_update_commander_part3_nichols_4.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-21', faction = 'Nomad'},	
}

M3_ProtectFactory = {
	{text = "[Nichols]: That captured factory is vulnerable. We need it to keep our advantage. Defend it Captain.", vid = 'nomads_m1_part3_protect_factory.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-22', faction = 'Nomad'},	
}

M3FactoryDead = {
	{text = "[Nichols]: We've lost the captured factory!", vid = 'nomads_m1_part3_factory_dead.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-23', faction = 'Nomad'},
...
EnemyDead = {
	...
	{text = "[Nichols]: The enemy Commander is down Captain, all nearby hostile forces are going down as we speak!", vid = 'nomads_m1_enemy_dead_nichols_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-24', faction = 'Nomad'},
	{text = "[Benson]: Our engines are operational again. We've finished repairs and are ready to launch.", vid = 'nomads_m1_enemy_dead_benson_1.sfd', bank = 'NMCA_001', cue = 'Benson_Audio_M1_03', faction = 'Nomad'},
	{text = "[Nichols]: It’s time to get you back up here with the rest of the fleet. I’m not sure you realize Captain, but we’ve just stepped foot into something bigger than anything we’ve encountered before. There’s a lot of commotion back at Command, and we might be right in the middle of it.", vid = 'nomads_m1_enemy_dead_nichols_2.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-25', faction = 'Nomad'},
}

Tech2AirFactoryBuilt = {
	{text = "[Nichols]: Target relay link is established. We can now select targets for an Air Strike sir.", vid = 'nomads_m1_tech2_air_factory_built.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-26', faction = 'Nomad'},
}

OrbStrikeReady = {
	{text = "[Nichols]: Air strike is now available sir.", vid = 'nomads_m1_orb_strike_ready.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-27', faction = 'Nomad'},
}
...
----------
M2P1Reminder = {
	{text = "[Nichols]: That outpost is still operational Captain. Destroy it as soon as possible.", vid = 'nomads_m1_reminder_1.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-28', faction = 'Nomad'},
}

M2P2Reminder = {
	{text = "[Nichols]: The missile launcher is still firing at us. Destroy it!", vid = 'nomads_m1_reminder_2.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-29', faction = 'Nomad'},
}

M2P3Reminder = {
	{text = "[Nichols]: Captain you need to capture that research facility, failure isn’t an option.", vid = 'nomads_m1_reminder_3.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-30', faction = 'Nomad'},
}

M3P1Reminder = {
	{text = "[Nichols]: You’ve been given your orders Captain, destroy the enemy commander!", vid = 'nomads_m1_reminder_4.sfd', bank = 'NMCA_001', cue = 'Freeze 1-Audio-31', faction = 'Nomad'},
}